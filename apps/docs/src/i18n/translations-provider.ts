...
translations.set('en-US', () => import('./translations/en-US.json').then(json => json.default));
translations.set('es-ES', () => import('./translations/es-ES.json').then(json => json.default));
