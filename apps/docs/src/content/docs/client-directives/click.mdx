...
import ClientDirectiveClickUseExample from './_examples/ClientDirectiveClickUseExample.astro';
import ClientDirectiveClickWithTriggerUseExample from './_examples/ClientDirectiveClickWithTriggerUseExample.astro';

import squareCodeExample from '@astro-tools/docs-utils/components/Square.svelte?raw';
import clientDirectiveClickSetupExampleRaw from './_examples/ClientDirectiveClickSetupExample.ts?raw';
import clientDirectiveClickUseExampleRaw from './_examples/ClientDirectiveClickUseExample.astro?raw';
import clientDirectiveClickWithTriggerUseExampleRaw from './_examples/ClientDirectiveClickWithTriggerUseExample.astro?raw';
