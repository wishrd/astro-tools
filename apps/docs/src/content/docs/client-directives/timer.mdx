...
<Aside type="note">Both integrations, `client:on` integration and this one, can be included in the project configuration, allowing you to use both directives, `client:timer="3000"` and `client:on="timer 3000"`, in your components.</Aside>
