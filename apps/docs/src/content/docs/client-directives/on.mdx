...
import ClientDirectiveOnUseExample from './_examples/ClientDirectiveOnUseExample.astro';

import clientDirectiveOnSetupExampleRaw from './_examples/ClientDirectiveOnSetupExample.ts?raw';
import clientDirectiveOnUseExampleRaw from './_examples/ClientDirectiveOnUseExample.astro?raw';
