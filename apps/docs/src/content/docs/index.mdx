...
<CardGrid>
  ...
  <LinkCard title="Network" description="Network related libraries to make your communication with other services even better!" href="/network/http-client/"></LinkCard>
  <LinkCard title="Tools" description="Tools using Astro under the hood or related with it for saving development time!" href="/tools/mdocs/"></LinkCard>
</CardGrid>
